...
def methodology():
    ...
    st.info("The following link redirect you to an article explaining the data science methodology in backend : [article](http://studio.datascientest.com:2652/) \n\n"
            "This article is in currently in French but an english version will be available soon."
            )
